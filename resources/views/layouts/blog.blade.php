...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-stick-dark" data-navbar="sticky">
      <div class="container">
        ...
        <div class="navbar-left">
          ...
          <a class="navbar-brand text-white text-uppercase" href="{{ route('welcome') }}">
            Usman Blog
          </a>
        </div>
        ...
        <!-- <a class="btn btn-xs btn-round btn-warning" href="">Register</a> -->
      ...
      <div class="container">
        <div class="row gap-y align-items-center">
          ...
          <div class="col-6 col-lg-3">
            <a href="{{ route('welcome') }}">Usman Blog</a>
          </div>
    ...
    <!-- Scripts -->
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5f55b6cec84502d4"></script>
